        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form class="col s12" method="POST" action="{{route('color4Save')}}">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <textarea id="textarea5" name="nota" class="materialize-textarea"></textarea>
                                        <label for="textarea5">Nota</label>
                                    </div>
                                </div>
